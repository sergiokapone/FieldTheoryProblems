...
Всередині незарядженої металевої кулі якимось чином зробили сферичну порожнину (рис.~\ref{pic:charge_in_hole}), в центрі якої помістили
заряд  $q$.
...
Всередині незарядженої металевої кулі якимось чином зробили сферичну порожнину (рис.~\ref{pic:charge_in_elhole}), в центрі якої помістили
заряд  $q$.
Знайти напруженість електричного поля в зовні кулі просторі.
\end{problem}
